package com.example.safechat.webSocket.interceptor;

import com.example.safechat.service.WebSocketAuthenticationService;
...
public class WebSocketAuthChannelInterceptor implements ChannelInterceptor {
    ...
    public Message<?> preSend(final Message<?> message, final MessageChannel channel) throws AuthenticationException {
        ...
        if (StompCommand.CONNECT == accessor.getCommand()) {
            ...
            final UsernamePasswordAuthenticationToken user = webSocketAuthenticationService.getAuthToken(username, password);
